                ...
                <div class="content-area" id="contentArea">
                    ...
                    <div class="create" id="createCourseSection">
                        <div class="create-course-container" style="text-align: center;">
                            ...
                            <form class="create" name="createChannelsForm" action="boardController.php" method="post" autocomplete="on">
                                ...
                                <!--Submit section-->
                                <input class="btn btn-primary" type="submit" name="create_channels" value="Create">
                            </form>
                        </div>
                    </div>
                </div>
