...
<html>
    ...
    <body>
        ...
        <form name="approveMembersForm" action="boardController.php" method="post" autocomplete="on">
            <!--Hidden field to determine whether form is register or login-->
            <input type="hidden" name="action" value="approve_members">
            <!-- Aligned text boxes-->
            <fieldset>
                <b id="name">Which user would you like to let in off the waiting list?</b>
            ...
            <!-- Submit section -->
            <input type="submit" name="approve_members" value="Approve">
        </form>
