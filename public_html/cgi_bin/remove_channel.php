                    ...
                    <div class="create" id="createCourseSection">
                        <div class="create-course-container" style="text-align: center;">
                            ...
                            <form name="removeChannelsForm" action="boardController.php" method="post" autocomplete="on">
                                ...
                                <!-- Aligned text boxes-->
                                <fieldset>
                                    <b id="name">What channel would you like to add or remove from this discussion board?</b> <br>
                                ...
                                <!-- Submit section -->
                                <input class="btn btn-primary" type="submit" name="remove_channels" value="Remove">
                            </form>
                        </div>
                    </div>
                </div>
